%% single_expert_dataset.m
% Runs Shauna O'Donovan's single-expert EDES fitting on all N=118 real
% patients from japan_population_labelled.mat and produces the same summary
% figures as final_architecture_dataset.m for direct comparison.
%
...
%
% Optimisation method (identical to Shauna's Fit_EDES_LatinHyperCube.m):
...
%
% Shauna's functions used (not modified):
...
%% -------------------------------------------------------------------------
%% Build input_data struct (compatible with Shauna's EDES_ErrorFunc)
%% -------------------------------------------------------------------------
...
%% -------------------------------------------------------------------------
%% Optimisation settings (Shauna's approach: Fit_EDES_LatinHyperCube.m)
%% -------------------------------------------------------------------------
...
save('single_expert_results.mat', 'k1_all', 'k5_all', 'k6_all', 'cats');
fprintf('Results saved to single_expert_results.mat\n\n');
