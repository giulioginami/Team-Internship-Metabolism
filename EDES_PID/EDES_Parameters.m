function out = EDES_Parameters(p_opt,input_data,row)
...
% row             - specify row in input data array to be fitted
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
out(13) = input_data.glucose(row,1);%G_b basal plasma glucose [mmol/l]
out(14) = input_data.insulin(row,1); %I_PL/_b basal plasma glucose [microU/ml]
