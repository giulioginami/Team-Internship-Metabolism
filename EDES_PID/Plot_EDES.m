function out = Plot_EDES(input_data,row,p_opt,time,plot_col)
% Plot measured data and EDES simulation for a given parameter set
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Inputs
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% row        - specifies row of input data array being plotted.
...
%% Generate figure
 ...
 hold on
 plot(input_data.time_G,input_data.glucose(row,:),'kx','MarkerSize',10,'LineWidth',1.5)
 ylabel('glucose (mmol/l)');
 ...
 hold on
 plot(input_data.time_I,input_data.insulin(row,:),'kx','MarkerSize',10,'LineWidth',1.5)
