function out = Fit_EDES(initial_par,input_data,row,time,lb,ub)
...
%row         - specifies row of input array to be fit
...
%Fit model to data
[p_opt,resnorm,residual,exitflag,output,lambda,jacobian]=lsqnonlin(@EDES_ErrorFunc,initial_par,lb,ub,lsq_options,input_data,row,time);
